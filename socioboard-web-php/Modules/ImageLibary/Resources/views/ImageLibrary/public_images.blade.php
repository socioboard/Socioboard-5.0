    ...
    <div class="content  d-flex flex-column flex-column-fluid" id="Sb_content">
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class=" container-fluid ">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card card-custom gutter-b card-stretch">
                            ...
                            <div class="card-header border-0 py-5">
                                <h3 class="card-title font-weight-bolder"> Image Library : Total Used Space - <span class="text-primary ml-3" id="usedSize"> {{number_format($images["data"]->usedSize/(1024*1024), 2)}}MB / {{number_format($images["data"]->totalSize/(1024*1024), 2)}}MB</span></h3>

                                <div class="card-toolbar">
                                    <!--begin::Teams Actions Dropdown-->
                                    <a href="javascript:;" class="btn btn-hover-text-success btn-sm" data-toggle="modal" data-target="#uploadImageModal" onclick="clearDataBeforeUpload()">
                                        Upload Images
                                    </a>
                ...
                <!--end::Row-->
                <form id="search_form" method="POST" action="/imagelibary/search-public-image">
                    @csrf
