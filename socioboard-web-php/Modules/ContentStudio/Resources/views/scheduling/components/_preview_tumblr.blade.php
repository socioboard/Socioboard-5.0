<div class="tab-pane fade" id="linkedin-preview" role="tabpanel" aria-labelledby="linkedin-tab-preview">
    <!--begin::Image-->
                ...
                <div class="d-flex justify-content-around mt-2">
                    <div class=" font-weight-bolder font-size-sm p-2 disabled">
                        <span class="svg-icon svg-icon-md svg-icon-danger">
                                <i class="far fa-thumbs-up fa-fw"></i> Like
                        </span>
                    </div>
                    <div class="font-weight-bolder font-size-sm p-2 disabled">
                    ...
                    <div class="font-weight-bolder font-size-sm p-2 disabled">
                        <span class="svg-icon svg-icon-md svg-icon-dark-25">
                            <i class="far fa-paper-plane fa-fw"></i> Send
                        </span>
                    </div>
                </div>
                <!--end::Action-->
