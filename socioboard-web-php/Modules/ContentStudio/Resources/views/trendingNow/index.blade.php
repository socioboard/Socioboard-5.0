...
@section('title')
    <title>{{env('WEBSITE_TITLE')}} | TrendingNow</title>
@endsection
                        ...
                        <div class="card card-custom gutter-b">
                            ...
                            <div class="card-body">
                                ...
                                <form>
                                    ...
                                    <div class="form-group mb-7">
                                        <label for="hashtag" class="font-size-h3 font-weight-bolder mb-7">Trending Hashtag</label>
                                        <div class="">
                                            <tags class="tagify form-control form-control-solid h-auto py-7 rounded-lg font-size-h6 tagify--outside" tabindex="-1">
                                                <tag title="BhagatSingh" contenteditable="false" spellcheck="false" tabindex="-1" class="tagify__tag tagify--noAnim" role="tag" __isvalid="true" value="BhagatSingh"><x title="" class="tagify__tag__removeBtn" role="button" aria-label="remove tag"></x><div><span class="tagify__tag-text">BhagatSingh</span></div></tag><tag title="RangonKiChingari" contenteditable="false" spellcheck="false" tabindex="-1" class="tagify__tag tagify--noAnim" role="tag" __isvalid="true" value="RangonKiChingari"><x title="" class="tagify__tag__removeBtn" role="button" aria-label="remove tag"></x><div><span class="tagify__tag-text">RangonKiChingari</span></div></tag><tag title="ChingariTrending" contenteditable="false" spellcheck="false" tabindex="-1" class="tagify__tag tagify--noAnim" role="tag" __isvalid="true" value="ChingariTrending"><x title="" class="tagify__tag__removeBtn" role="button" aria-label="remove tag"></x><div><span class="tagify__tag-text">ChingariTrending</span></div></tag><span contenteditable="" data-placeholder="Enter Hashtag" aria-placeholder="Enter Hashtag" class="tagify__input" role="textbox" aria-autocomplete="both" aria-multiline="false"></span>
                                            </tags>
                                            <input class="form-control form-control-solid h-auto py-7 rounded-lg font-size-h6 tagify--outside" type="text" id="hashtag" name="hashtag" autocomplete="off" placeholder="Enter Hashtag" value="BhagatSingh, RangonKiChingari, ChingariTrending">
                                        </div>
                                    </div>
...
@section('scripts')
    <script>
        $('#trendingNow').css('background','#e4e4e4').find('span').css('color','#3699FF');
    </script>
@endsection
