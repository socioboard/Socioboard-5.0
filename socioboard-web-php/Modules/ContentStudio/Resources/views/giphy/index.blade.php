...
@section('title')
    <title>{{env('WEBSITE_TITLE')}} | Giphy</title>
@endsection
        ...
        <div class="d-flex flex-column-fluid">
            ...
            <div class=" container-fluid ">
                ...
                <div class="row" data-sticky-container="">
                    {!! $html !!}
                    <p id="notification">Please enter the keyword for find gyphy’s </p>
                    <div class="col-xl-8">
                        <!--begin::Feeds-->
...
@section('scripts')
    ...
    <script>
        $('#giphy').css('background', '#e4e4e4').find('span').css('color', '#3699FF');
        let nextUrl = 'giphy';
    </script>
@endsection
