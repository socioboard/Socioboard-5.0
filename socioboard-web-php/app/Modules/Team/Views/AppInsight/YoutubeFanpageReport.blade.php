                ...
                <span class="card_social_ribbon">
                  <i class="fab fa-youtube"></i>
                    ...
                    <div class="card-footer bg-transparent">
                        ...
                        <a href="{{env('APP_URL')}}get-youtube-feeds/{{$profileData->account_id}}/{{$profileData->account_type}}" class="btn btn-outline-dark col-md-12 margin-top-10">View Feeds</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="shadow mb-5 bg-white yt-card rounded">
                        <div class="card-body">
                            <h5 class="feeds_title blue lighten-3 white-text mb-0">
                                <i class="fab fa-youtube-square"></i>YOUTUBE STATS
                            </h5>
                            <small>Stats for your Youtube account in the Socioboard group.</small>
                            <hr/>
        ...
        function  getFacebookInsight(accountId, filterPeriod, since, until){
            $.ajax({
                ...
                success: function(response){
                    ...
                    createAxisAndSeries("likes", "Likes", false, "circle");
                    createAxisAndSeries("dislikes", "Dislikes", true, "triangle");
                    createAxisAndSeries("averageViewDuration", "averageViewDuration", true, "rectangle");
