...
@section('Facebook')
                ...
                <span class="card_social_ribbon">
                  <i class="fab fa-facebook-f"></i>
                    ...
                    <div class="card-footer bg-transparent">
                        <a href="{{env('APP_URL')}}view-facebook-feeds/{{$profileData->account_id}}" class="btn btn-outline-dark col-md-12 margin-top-10">View Feeds</a>
                ...
                <div class="fb_reports_div">
                    <div class="bg-white fb-card">
                        <div class="card-body">
                            ...
                            <small
                                    >Stats for Facebook accounts in the Socioboard group.</small
                                    >
                            <hr />
    ...
    <script>
        ...
        getFacebookInsight(fbId,filterPeriod);
                    ...
                    if(response.code == 200){
                        ...
                        $.each(response.data, function(key,value){
                            ...
                            $.each(value, function(key1,value1){
                                chartData.push({
                                    date: value1.date,
                                    likes:  value1.page_fan_adds,
                                    dislikes: value1.page_fan_removes,
                                    impressions: value1.page_impressions
                                });
                            });
                        });
