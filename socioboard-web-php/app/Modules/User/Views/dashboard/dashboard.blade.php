                ...
                <div class="card-body">
                    <div>
                        ...
                        @if( $activation['user_plan'] == env('BASIC') )
                            <h6><span style="font-size: 2rem;">Basic plan </span> <a href="{{env('APP_URL')}}updatePlan"
                                                                                     class="badge badge-info float-right"
                                                                                     style="margin-top: 5px;">Upgrade
                                    it !</a></h6>
                        @elseif($activation['user_plan'] == env('STANDARD'))
                            <h6><span style="font-size: 2rem;">Standard</span> <a href="{{env('APP_URL')}}updatePlan"
                                                                                  class="badge badge-info float-right"
                                                                                  style="margin-top: 5px;">Upgrade
                                    it !</a></h6>
                        @elseif($activation['user_plan'] == env('PREMIUM'))
                            <h6><span style="font-size: 2rem;">Premium User</span> <a
                                    href="{{env('APP_URL')}}updatePlan" class="badge badge-info float-right"
                                    style="margin-top: 5px;">Upgrade
                                    it !</a</h6>
                        @elseif($activation['user_plan'] == env('DELUXE'))
                            <h6><span style="font-size: 2rem;">Deluxe User</span> <a href="{{env('APP_URL')}}updatePlan"
                                                                                     class="badge badge-info float-right"
                                                                                     style="margin-top: 5px;">Upgrade
                                    it !</a></h6>
                        @elseif($activation['user_plan'] == env('TOPAZ'))
                            <h6><span style="font-size: 2rem;">Topaz User</span> <a href="{{env('APP_URL')}}updatePlan"
                                                                                    class="badge badge-info float-right"
                                                                                    style="margin-top: 5px;">Upgrade
                                    it !</a></h6>
                        @elseif($activation['user_plan'] == env('RUBY'))
                            <h6><span style="font-size: 2rem;">Ruby User</span> <a href="{{env('APP_URL')}}updatePlan"
                                                                                   class="badge badge-info float-right"
                                                                                   style="margin-top: 5px;">Upgrade
                                    it !</a></h6>
                        @elseif($activation['user_plan'] == env('GOLD'))
                            <h6><span style="font-size: 2rem;">Gold User</span> <a href="{{env('APP_URL')}}updatePlan"
                                                                                   class="badge badge-info float-right"
                                                                                   style="margin-top: 5px;">Upgrade
                                    it !</a></h6>
                        @elseif($activation['user_plan'] == env('PLATINUM'))
                            <h6><span style="font-size: 2rem;">Platinum User</span></h6>
        ...
        <div class="col-md-4">
            <div class="shadow mb-5 bg-white rounded">
                ...
                <div class="card-footer bg-transparent text-center">
                    ...
                    <button class="btn btn-primary col-12" data-toggle="modal" data-target="#addProfileModal">Add
                        Accounts
                    </button>
                    <p class="margin-top-10"><b>*Note:</b> Click on "<b class="text-blue"> Add Accounts </b>" button to
                        add social
                        profiles like
                        [ Facebook,
                        Twitter,
...
@section('addaccountModal')
    <div class="modal fade addFacebookPageModal" id="addProfileModal" tabindex="-1" role="dialog"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist" style="margin-left: 100px">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-facebook-tab" data-toggle="pill" href="#pills-facebook"
                               role="tab"
                               aria-controls="pills-facebook" aria-selected="true"><i class="fab fa-facebook-f"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-twitter-tab" data-toggle="pill" href="#pills-twitter"
                               role="tab" aria-controls="pills-twitter"
                               aria-selected="false"><i class="fab fa-twitter"></i></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-instagram-tab" data-toggle="pill" href="#pills-instagram"
                               role="tab"
                               aria-controls="pills-instagram" aria-selected="false"><i
                        ...
                        {{--</li>--}}
                        <li class="nav-item">
                            <a class="nav-link" id="pills-youtube-tab" data-toggle="pill" href="#pills-youtube"
                               role="tab" aria-controls="pills-youtube"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        ...
                        <div class="tab-pane fade show active" id="pills-facebook" role="tabpanel"
                            ...
                            <div class="text-center">
                                <p>Socioboard needs permission to access and publish content to Facebook on your behalf.
                                    To grant permission,

                                    you must be an admin for your brand's Facebook page.</p>

                                <a href="{{env('APP_URL')}}facebook-add/{{env('ACCOUNT_ADD_FB')}}/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-fb btn-sm">Add a Facebook Profile</button>
                                </a>
                                <a href="{{env('APP_URL')}}facebook-add/{{env('ACCOUNT_ADD_FBP')}}/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-fb btn-sm fb_page_btn">Add a Facebook Fanpage
                                    </button>
                                </a>
                            </div>
                            <?php $fbPageCount = 0; ?>
                                ...
                                <div class="card margin-top-10 fb_page_div">
                                    <div class="card-body bg-white">
                                                    ...
                                                    @for($i=0; $i<count(session()->get('facebookPage')); $i++)
                                                        <div class="media">
                                                            <img class="mr-3 pp_50 rounded-circle"
                                                                 src="{{session()->get('facebookPage')[$i]->profilePicture}}"
                                                                 alt="page title">
															...
															<span class="float-right badge badge-secondary">
																<div class="custom-control custom-checkbox"
                                                                    ...
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           id="{{session()->get('facebookPage')[$i]->pageId}}"
                                                                           name="{{session()->get('facebookPage')[$i]->pageName}}">
                                                                    <label class="custom-control-label"
                                                                           for="{{session()->get('facebookPage')[$i]->pageId}}"><span
                                        ...
                                        <div class="">
                                            ...
                                            <button type="button" id="checkedPages"
                                                    class="btn btn-fb btn-sm margin-top-10 float-right">Add <i
                        ...
                        <div class="tab-pane fade" id="pills-twitter" role="tabpanel"
                            ...
                            <div class="text-center">
                                <p>Please make sure you are logged in with the proper account when you authorize
                                    Socioboard.</p>
                                <a href="{{env('APP_URL')}}twitter/{{$currentTeam['team_id']}}">
                                    <button class="btn btn-sm btn-twt">Add a Twitter Profile</button>
                                </a>
                                <div class="form-group custom-control custom-checkbox margin-top-10">
                                    ...
                                    <label class="custom-control-label text-gray-light" for="Remember_check">Follow
                                        Socioboard on twitter for
                        ...
                        <div class="tab-pane fade" id="pills-instagram" role="tabpanel"
                            ...
                            <div class="text-center">
                                <p>To allow Socioboard access to your Instagram account, you must first give
                                    authorization from the Instagram
                                    website.</p>
                                <a href="{{env('APP_URL')}}instagram/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-inst btn-sm">Add a Instagram Profile</button>
                                </a>
                                <a href="{{env('APP_URL')}}/facebook-add/{{env('ACCOUNT_ADD_INSTAGRAM_PAGE')}}/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-inst btn-sm">Add a Instagram business page
                                    </button>
                                </a>
                            </div>
                            ...
                            @if($instaBusiness == 1)
                                ...
                                <div class="card margin-top-10 fb_page_div">
                                    <div class="card-body bg-white">
                                            ...
                                            <ul class="list-group">
                                                ...
                                                <li class="list-group-item page_list">
                                                    ...
                                                    @for($i=0; $i<count(session()->get('InstaBusiness')); $i++)
                                                        <div class="media">
                                                            <img class="mr-3 pp_50 rounded-circle"
                                                                 src="{{session()->get('InstaBusiness')[$i]->profile_pic}}"
                                                                 alt="page title">
                                                            <div class="media-body">
															<span class="float-right badge badge-secondary">
																<div class="custom-control custom-checkbox"
                                                                     id="InstaBusinesscheckboxes">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           id="{{session()->get('InstaBusiness')[$i]->social_id}}"
                                                                           name="{{session()->get('InstaBusiness')[$i]->userName}}">
                                                                    <label class="custom-control-label"
                                                                           for="{{session()->get('InstaBusiness')[$i]->social_id}}"><span
                                                                            style="display: flex; margin-top: 6px;">Add</span></label>
                                                                </div>
															</span>
                                        ...
                                        <div class="">
                                            <p class="float-left">&nbsp;</p>
                                            <button type="button" id="checkedInstaBusiness"
                                                    class="btn btn-fb btn-sm margin-top-10 float-right">Add <i
                                                    class="far fa-plus-square"></i></button>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="pills-linkedin" role="tabpanel"
                             aria-labelledby="pills-linkedin-tab">
                            <div class="text-center">
                            ...
                            @if($lnccount == 1)
                                <div class="card margin-top-10 in_page_div">
                                    <div class="card-body bg-white">
                                                ...
                                                <li class="list-group-item page_list">
                                                    ...
                                                    @for($i=0; $i<count(session()->get('linkedCompany')); $i++)
                                                        @if(session()->get('linkedCompany')[$i]->isAlreadyAdded != true)
                                                            <div class="media">
                                                                <img class="mr-3 pp_50 rounded-circle"
                                                                     src="{{session()->get('linkedCompany')[$i]->profileUrl}}"
                                                                     alt="page title">
                                                                <div class="media-body">
															<span class="float-right badge badge-secondary">
																<div class="custom-control custom-checkbox"
                                                                     id="linkedincheckboxes">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           id="{{session()->get('linkedCompany')[$i]->companyId}}"
                                                                           name="{{session()->get('linkedCompany')[$i]->companyName}}">
                                                                    <label class="custom-control-label"
                                                                           for="{{session()->get('linkedCompany')[$i]->companyId}}"><span
                                                                            style="display: flex; margin-top: 6px;">Add</span></label>
                                                                </div>
															</span>
                                        ...
                                        <div class="">
                                            <p class="float-left">&nbsp;</p>
                                            <button type="button" id="checkedCompany"
                                                    class="btn btn-fb btn-sm margin-top-10 float-right">Add <i
                                                    class="far fa-plus-square"></i></button>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="pills-youtube" role="tabpanel"
                            ...
                            <div class="text-center">
                                <p>To allow Socioboard access to your Youtube account, you must first give authorization
                                    from the Youtube
                                    website.</p>
                                <a href="{{env('APP_URL')}}google-account-add/{{env('ACCOUNT_ADD_YOUTUBE')}}/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-yt btn-sm">Connect your personal youtube
                                    </button>
                                </a>
                            </div>
                                    ...
                                    <div class="card-body bg-white">
                                            ...
                                            <ul class="list-group">
                                                <li class="list-group-item page_list">
                                                    ...
                                                    @for($i=0; $i<count(session()->get('youtubeChannels')); $i++)
                                                        ...
                                                        <div class="media">
                                                            <img class="mr-3 pp_50 rounded-circle"
                                                                 src="{{session()->get('youtubeChannels')[$i]->channelImage}}"
                                                                 alt="page title">
                                                            <div class="media-body">
															<span class="float-right badge badge-secondary">
																<div class="custom-control custom-checkbox"
                                                                     id="channelCheckboxes">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           id="{{session()->get('youtubeChannels')[$i]->channelId}}"
                                                                           name="{{session()->get('youtubeChannels')[$i]->channelName}}">
                                                                    <label class="custom-control-label"
                                                                           for="{{session()->get('youtubeChannels')[$i]->channelId}}"><span
                                                                            style="display: flex; margin-top: 6px;">Add</span></label>
                                                                </div>
															</span>
                                                        ...
                                                        @else
                                                            <div class="media">
                                                                Channel {{session()->get('youtubeChannels')[$i]->channelName }}
                                                                is already added
                                                            </div>
                                        ...
                                        <div class="">
                                            @if($youtubeChannelsCount > 0)
                                                <p class="float-left">&nbsp;</p>
                                                <button type="button" id="checkedChannels"
                                                        class="btn btn-fb btn-sm margin-top-10 float-right">Add <i
                                                        class="far fa-plus-square"></i></button>
                                            @endif
                                        </div>
                        ...
                        <div class="tab-pane fade" id="pills-google-analytics" role="tabpanel"
                             aria-labelledby="pills-google-analytics-tab">
                            <div class="text-center">
                                <p>Add your Google Analytics Account to see how your website traffic correlates with
                                    your social media
                                    activity.</p>
                                <a href="{{env('APP_URL')}}google-account-add/{{env('ACCOUNT_ADD_GA')}}/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-orange btn-sm">Connect your personal
                                        GoogleAnalytics
                                    </button>
                                </a>
                            </div>
                            ...
                            @if($ganalyticscount == 1)
                                <div class="card margin-top-10 in_page_div">
                                    <div class="card-body bg-white">
                                                ...
                                                <li class="list-group-item page_list">
                                                    @for($i=0; $i<count(session()->get('GoogleAnalytics')); $i++)
                                                        @if(!isset(session()->get('GoogleAnalytics')[$i]->isAlreadyAdded))
                                                            <div class="media">
                                                                <img class="mr-3 pp_50 rounded-circle"
                                                                     src="{{session()->get('GoogleAnalytics')[$i]->profileUrl}}"
                                                                     alt="page title">
                                                                <div class="media-body">
															<span class="float-right badge badge-secondary">
																<div class="custom-control custom-checkbox"
                                                                     id="Analyticscheckboxes">
                                                                    <input type="checkbox" class="custom-control-input"
                                                                           id="{{session()->get('GoogleAnalytics')[$i]->socialId}}"
                                                                           name="{{session()->get('GoogleAnalytics')[$i]->firstName}}">
                                                                    <label class="custom-control-label"
                                                                           for="{{session()->get('GoogleAnalytics')[$i]->socialId}}"><span
                                                                            style="display: flex; margin-top: 6px;">Add</span></label>
                                                                </div>
															</span>
                                        ...
                                        <div class="">
                                            <p class="float-left">&nbsp;</p>
                                            <button type="button" id="checkedAnalytic"
                                                    class="btn btn-fb btn-sm margin-top-10 float-right">Add <i
                                                    class="far fa-plus-square"></i></button>
                                        </div>
                                    </div>
                        ...
                        <div class="tab-pane fade" id="pills-pinterest" role="tabpanel"
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{env('APP_URL')}}pinterest/{{env('ACCOUNT_ADD_PINTEREST')}}/{{$currentTeam['team_id']}}">
                                    <button type="button" class="btn btn-pin btn-sm">Connect your Pinterest</button>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal"><i
                            class="fas fa-times"></i> No
                    </button>
                    <button type="button" onclick="del()" class="btn btn-danger btn-sm"><i class="fas fa-check"></i> Yes
                    </button>
                </div>
            </div>
        </div>
                ...
                <div class="modal-body p-2">
                    <form id="publishForm">
                        ...
                        <div class="form-group">
								<textarea name="message" class="form-control border border-light" id="normal_post_area"
                                          rows="3"
                                          placeholder="Write something !"></textarea>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control border border-light" name="link" id="outgoing_link"
                                   placeholder="Enter outgoing link">
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="button" id="add-account-for-publish"
                                        class="btn btn-fb btn-sm all_social_btn">Add Accounts
                                </button>
                                                                ...
                                                                @if( $socialAccount[$i]->account_type == env('PINTEREST'))
                                                                    @if($socialAccount[$i]->join_table_teams_social_accounts->is_account_locked == false)
                                                                        <div class="card border-0">
                                                                            <div
                                                                                class="card-header bg-danger text-white p-1 m-0"
                                                                                id="headingOne"
                                                                                                                ...
                                                                                                                <span
                                                                                                                    ...
                                                                                                                    <div
                                                                                                                        ...
                                                                                                                        <input
                                                                                                                            type="checkbox"
                                                                                                                            class="custom-control-input"
                                                                                                                            id="{{$pinterestBoards[$j]->account_id}}_{{$pinterestBoards[$j]->boards[$l]->board_id}}"
                                                                                                                            name="{{$pinterestBoards[$j]->account_id}}_{{$pinterestBoards[$j]->boards[$l]->board_id}}">
                                                                                                                        <label
                                                                                                                            class="custom-control-label"
                                                                                                                            for="{{$pinterestBoards[$j]->account_id}}_{{$pinterestBoards[$j]->boards[$l]->board_id}}">
                                                                                                                            <span
                                                                                                                                style="display: flex; margin-top: 6px;">Add</span>
                                                                                                                        </label>
                                                                                                                    </div>
                                                                                                                </span>
                            ...
                            <div class="float-right">
                                <button type="button" onclick="post(0)" class="btn btn-secondary"><i id="draftspinstyle"
                                                                                                     class="fa fa-spinner fa-spin"
                                                                                                     style="display: none"></i>
                                    <span id="draftspin">Draft</span></button>
                                <button type="button" onclick="post(1)" class="btn btn-primary"><i id="test"
                                                                                                   class="fa fa-spinner fa-spin"
                                                                                                   style="display: none"></i>
                                    <span id="testText">Post</span></button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <div class="">
        <button type="button" class="btn btn-primary btn-lg shadow post_floating_btn" data-toggle="modal"
                            ...
                            switch (value.account_type) {
                                ...
                                case 2:
                                    ...
                                    if (value.join_table_teams_social_accounts.is_account_locked === false) {
                                        ...
                                        data += '<div class="col-md-4 active_account "> <div class="shadow mb-5 bg-white fb-card rounded"> <div class="card_deactivate"> <span class="card_social_ribbon"> <i class="fab fa-facebook-f"></i> </span> <div class="profile_action_dropdown dropleft"> <span class="dropdown-toggle" id="profile_drop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > <i class="fas fa-chevron-down"></i> </span> <div class="dropdown-menu" aria-labelledby="profile_drop"> <a class="dropdown-item" onclick="lock(' + value.account_id + ',0);"><i class="fas fa-user-lock fa-fw"></i> Un-Lock this account</a > <a class="dropdown-item profile_close" onclick="SocialAccountDelete(' + value.account_id + ');"><i class="far fa-trash-alt fa-fw"></i> Delete this account</a > </div> </div> <div class="text-center"> <img class="rounded-circle card-avatar" src="' + value.profile_pic_url + '" alt="profile picture" /> <h5 class="card-title no-space">' + value.first_name + '</h5> <p class="card-text">' + value.email + '</p> </div> <div class="row text-center mt-1"><div class="col-md-6"> <h5>' + value.friendship_counts + '</h5></div> <div class="col-md-6"> <h5>Friends</h5> </div> </div> <div class="card-footer bg-transparent"> <a href="#" class="btn btn-primary col-md-12" >View Feeds</a > </div> </div> </div> </div>'
                                ...
                                case 4:
                                    if (value.join_table_teams_social_accounts.is_account_locked === false) {
                                        //do not add deactive class
                                        twitter += '<div class="col-md-4 active_account "> <div class="shadow mb-5 bg-white fb-card rounded"> <div class="card-body"> <span class="card_social_ribbon"> <i class="fab fa-twitter"></i> </span> <div class="profile_action_dropdown dropleft"> <span class="dropdown-toggle" id="profile_drop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > <i class="fas fa-chevron-down"></i> </span> <div class="dropdown-menu" aria-labelledby="profile_drop"> <a class="dropdown-item" onclick="lock(' + value.account_id + ',1);" ><i class="fas fa-user-lock fa-fw"></i> Lock this account</a > <a class="dropdown-item profile_close" onclick="SocialAccountDelete(' + value.account_id + ');"><i class="far fa-trash-alt fa-fw"></i> Delete this account</a > </div> </div> <div class="text-center"> <img class="rounded-circle card-avatar" src="' + value.profile_pic_url + '" alt="profile picture" /> <h5 class="card-title no-space">' + value.first_name + '</h5> </div> <div class="row text-center mt-1"><div class="col-md-6"> <h5>' + value.friendship_counts + '</h5></div> <div class="col-md-6"> <h5>Following</h5> </div> </div> </div> <div class="card-footer bg-transparent"> <a href="{{env('APP_URL')}}view-twitter-feeds/' + value.account_id + '" class="btn btn-primary col-md-12" >View Feeds</a > </div> </div> </div>'

                                    } else {
                                        twitter += '<div class="col-md-4 active_account "> <div class="shadow mb-5 bg-white fb-card rounded"> <div class="card_deactivate"> <span class="card_social_ribbon"> <i class="fab fa-twitter"></i> </span> <div class="profile_action_dropdown dropleft"> <span class="dropdown-toggle" id="profile_drop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > <i class="fas fa-chevron-down"></i> </span> <div class="dropdown-menu" aria-labelledby="profile_drop"> <a class="dropdown-item" onclick="lock(' + value.account_id + ',0);"><i class="fas fa-user-lock fa-fw"></i> Un-Lock this account</a > <a class="dropdown-item profile_close" onclick="SocialAccountDelete(' + value.account_id + ');"><i class="far fa-trash-alt fa-fw"></i> Delete this account</a > </div> </div> <div class="text-center"> <img class="rounded-circle card-avatar" src="' + value.profile_pic_url + '" alt="profile picture" /> <h5 class="card-title no-space">' + value.first_name + '</h5> </div> <div class="row text-center mt-1"><div class="col-md-6"> <h5>' + value.friendship_counts + '</h5></div> <div class="col-md-6"> <h5>Following</h5> </div> </div> <div class="card-footer bg-transparent"> <a href="#" class="btn btn-primary col-md-12" >View Feeds</a > </div> </div> </div> </div>'
...
//                                    twitter += '<div class="col-md-4 active_account"><div class="shadow mb-5 bg-white twt-card rounded"><div class="card-body"><span class="card_social_ribbon"><i class="fab fa-twitter"></i></span><span class="profile_close" onclick="SocialAccountDelete('+value.account_id+');"><i class="fas fa-times"></i></span><div class="text-center"><img class="rounded-circle" src="'+value.profile_pic_url+'" alt="profile picture"><h5 class="card-title">'+value.first_name+'</h5></div><div class="row"><div class="col-md-6"> <div class="text-center"> <h5>'+value.friendship_counts+'</h5> </div></div> <div class="col-md-6">   <h5>Follower</h5></div>  </div> </div> <div class="card-footer bg-transparent"><a href="#" class="btn btn-primary col-md-12">View Feeds</a> <a href="#" class="btn btn-dark col-md-12 margin-top-10">Update Profile</a>  <a href="#" class="btn btn-outline-dark col-md-12 margin-top-10">View Account</a></div></div> </div>'
                                ...
                                case 5:
                                    if (value.join_table_teams_social_accounts.is_account_locked === false) {
                                        ...
                                        insta += '<div class="col-md-4 active_account"> <div class="shadow mb-5 bg-white inst-card rounded"> <div class="card_deactivate"> <span class="card_social_ribbon"> <i class="fab fa-instagram"></i> </span> <div class="profile_action_dropdown dropleft"> <span class="dropdown-toggle" id="profile_drop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" > <i class="fas fa-chevron-down"></i> </span> <div class="dropdown-menu" aria-labelledby="profile_drop"> <a class="dropdown-item" onclick="lock(' + value.account_id + ',0);" ><i class="fas fa-user-lock fa-fw"></i> Un-Lock this account</a > <a class="dropdown-item profile_close" onclick=" SocialAccountDelete(' + value.account_id + '); "><i class="far fa-trash-alt fa-fw"></i> Delete this account</a > </div> </div> <div class="text-center"> <img class="rounded-circle card-avatar" src="' + value.profile_pic_url + '" alt="profile picture" /> <h5 class="card-title no-space">' + value.first_name + '</h5> <p class="card-text">' + value.email + '</p> </div> <div class="row text-center mt-1"><div class="col-md-6"> <h5>' + value.friendship_counts + '</h5></div> <div class="col-md-6"> <h5>Following</h5> </div> </div> <div class="card-footer bg-transparent"> <a href="#" class="btn btn-primary col-md-12" >View Feeds</a > </div> </div> </div> </div>'
...
//                                        alert(value.profile_pic_url);
                                        ...
                                        instaB += ' <div class="col-md-4 active_account"> <div class="shadow mb-5 bg-white inst-card rounded"> <div class="card_deactivate"> <span class="card_social_ribbon"> <i class="fab fa-instagram"></i> </span> <div class="profile_action_dropdown dropleft"> <span class="dropdown-toggle" id="profile_drop" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-chevron-down"></i> </span> <div class="dropdown-menu" aria-labelledby="profile_drop"> <a class="dropdown-item"onclick="lock(' + value.account_id + ',0);"><i class="fas fa-user-lock fa-fw"></i> Un-Lock this account</a> <a class="dropdown-item profile_close" onclick="SocialAccountDelete(' + value.account_id + ');"><i class="far fa-trash-alt fa-fw"></i> Delete this account</a> </div> </div> <div class="text-center"> <img class="rounded-circle card-avatar" src="' + value.profile_pic_url + '"alt="profile picture" /> <h5 class="card-title no-space">' + value.first_name + '</h5> <p class="card-text">' + value.email + '</p> </div> <div class="row text-center mt-1"> <div class="col-md-6"> <h5>' + value.friendship_counts + '</h5> </div> <div class="col-md-6"> <h5>Follower</h5> </div> </div> <div class="card-footer bg-transparent"> <a href="#" class="btn btn-primary col-md-12">View Report</a> </div> </div> </div> </div>'
                                    }
