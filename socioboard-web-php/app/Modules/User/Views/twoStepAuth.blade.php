...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="index.html"><strong><i class="fas fa-yin-yang"></i> <span class="text-orange-dark">Socio</span><span
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-item nav-link" href="signin.html">SignIn <span class="sr-only">(current)</span></a>
                </li>
            </ul>
        </div>
    </nav>
...
<main>
    <section class="container">
        <div class="row justify-content-md-center margin-bottom-50 margin-top-50">
            <div class="col col-md-6">
                <div class="card shadow mb-5">
                    <div class="card-body" style="padding: 40px;">
                        ...
                        <form class="margin-top-30 needs-validation" novalidate action="users/dashboard.html"
                              method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12">
                                    <button class="btn bg-orange-dark float-right col-12" onclick="smsLogin();">Login
                                        via SMS</button>
                                </div>
                            </div>
                            <div>
                                <div class="text-center m-3"><b>or</b></div>
                                <div class="form-group">
                                    <label for="email">Enter Email<span class="text-orange-dark">*</span></label>
                                    <input placeholder="Email id" class="form-control" id="email">
                                </div>
                                <button class="btn bg-orange-dark float-right col-12" onclick="emailLogin();">Login
                                    via Email</button>
                            </div>
                        </form>
                    </div>
            ...
            <form id="login_success" name="login" action="http://localhost:3000/v1/twoStepLoginSuccess" method="POST"
                  style="display: none;">
