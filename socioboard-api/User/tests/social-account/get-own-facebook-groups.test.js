...
import { GET_OWN_FACEBOOK_GROUPS, SERVER } from '../constants';
...
const user = {
  username: 'testGetOwnFacebookGroups',
  email: 'testGetOwnFacebookGroups@testtest.com',
...
describe('Get own facebook groups', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .post(GET_OWN_FACEBOOK_GROUPS)
