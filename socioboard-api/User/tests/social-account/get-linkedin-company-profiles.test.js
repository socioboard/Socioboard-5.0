...
import { GET_LINKEDIN_COMPANY_PROFILES, SERVER } from '../constants';
...
const user = {
  username: 'testGetLinkedinCompanyProfiles',
  email: 'testGetLinkedinCompanyProfiles@testtest.com',
...
describe('Get linkedin company profiles', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .post(GET_LINKEDIN_COMPANY_PROFILES)
