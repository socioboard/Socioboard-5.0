...
import { GET_OWN_FACEBOOK_PAGES, SERVER } from '../constants';
...
const user = {
  username: 'testGetOwnFacebookPages',
  email: 'testGetOwnFacebookPages@testtest.com',
...
describe('Get own facebook pages', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .post(GET_OWN_FACEBOOK_PAGES)
