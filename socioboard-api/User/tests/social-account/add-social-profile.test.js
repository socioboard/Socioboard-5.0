...
import { ADD_SOCIAL_PROFILE, SERVER } from '../constants';
...
const user = {
  username: 'testAddSocialProfile',
  email: 'testAddSocialProfile@testtest.com',
...
describe('Add social profile', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .post(ADD_SOCIAL_PROFILE)
