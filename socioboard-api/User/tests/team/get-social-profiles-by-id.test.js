...
import { GET_SOCIAL_PROFILES_BY_ID, SERVER } from '../constants';
...
const user = {
  username: 'testGetSocialProfilesById',
  email: 'testGetSocialProfilesById@testtest.com',
...
describe('Get social profiles by id', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .post(GET_SOCIAL_PROFILES_BY_ID)
  ...
  test('If access token is provided but request params are missed', async () => {
    await request(SERVER)
      .post(GET_SOCIAL_PROFILES_BY_ID)
      .set('accept', 'application/json')
      .set('Content-Type', 'application/json')
  ...
  test('If access token and request params are provided', async () => {
    await request(SERVER)
      .post(GET_SOCIAL_PROFILES_BY_ID)
      .query({
        accountId: userId,
