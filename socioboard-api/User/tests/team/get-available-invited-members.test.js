...
import { GET_AVAILABLE_INVITED_MEMBERS, SERVER } from '../constants';
...
const user = {
  username: 'testGetAvailableInvitedMembers',
  email: 'testGetAvailableInvitedMembers@testtest.com',
...
describe('Get available invited members', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .get(GET_AVAILABLE_INVITED_MEMBERS)
