...
import { GET_AVAILABLE_TEAM_MEMBERS, SERVER } from '../constants';
...
const user = {
  username: 'testGetAvailableTeamMembers',
  email: 'testGetAvailableTeamMembers@testtest.com',
...
describe('Get available team members', () => {
  test('If access token is not provided', async () => {
    await request(SERVER)
      .get(GET_AVAILABLE_TEAM_MEMBERS)
