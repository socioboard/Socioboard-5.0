...
import RssSearchedUrls from '../../../Common/Mongoose/models/rsssearchedurls.js'
...
class RssFeedsService {
    ...
    async getRssFeeds(req, res, next) {
        try {
            ...
            let data = await this.trendsServices.fetchRssFeedsNew(rssUrl)
            let insertData = await feedModel.addRssSearchUrls(req.body.userScopeId, rssUrl)
    ...
    async getRecentRssUrl(req, res, next) {
        try {
            ...
            let data = await rssSearchedUrls.getPreviousPost(req.body.userScopeId, 0, config.get('rssUrl.max_history'))
            return SuccessResponse(res, data)
        } catch (err) {
            return CatchResponse(res, err.message);
        }
    ...
    async getBookMarkedRssUrl(req, res, next) {
        try {
            let rssSearchedUrls = new RssSearchedUrls()
            let data = await rssSearchedUrls.getBookMarkedPost(req.body.userScopeId)
            return SuccessResponse(res, data)
        } catch (err) {
            return CatchResponse(res, err.message);
        }
    ...
    async bookmarkUrl(req, res, next) {
        try {
            let rssSearchedUrls = new RssSearchedUrls()
            let data = await rssSearchedUrls.bookmarkUrl(req.body.userScopeId, req.query.id, req.query.bookmark)
            return SuccessResponse(res, data)
        } catch (err) {
            return CatchResponse(res, err.message);
        }
    ...
    async updateRssUrls(req, res, next) {
        try {
            let rssSearchedUrls = new RssSearchedUrls()
            let data = await rssSearchedUrls.updateRssUrls(req.body.userScopeId, req.query.id, req.body)
            return SuccessResponse(res, data)
        } catch (err) {
            return CatchResponse(res, err.message);
        }
    ...
    async deleteRssUrls(req, res, next) {
        try {
            let rssSearchedUrls = new RssSearchedUrls()
            let data = await rssSearchedUrls.deleteRssUrls(req.body.userScopeId, req.query.id)
            return SuccessResponse(res, data)
        } catch (err) {
            return CatchResponse(res, err.message);
        }
    ...
    async clearRssUrls(req, res, next) {
        try {
            let rssSearchedUrls = new RssSearchedUrls()
            let data = await rssSearchedUrls.clearRssUrls(req.body.userScopeId)
            return SuccessResponse(res, data)
        } catch (err) {
            return CatchResponse(res, err.message);
        }
