        ...
        return authorizedLibs.changePassword(req.body.userScopeId, req.query.currentPassword, req.query.newPassword)
            .then(() => {
                analyticsServices.registerEvents({
                    ...
                    label: configruation.user_service_events.authorized_event_label.change_password.replace('{{user}}', req.query.userScopeName)
                });
                ...
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_password_failed.replace('{{user}}', req.query.userScopeName)
                });
            ...
            .then(function (userInformation) {
                if (!userInformation) {
                    analyticsServices.registerEvents({
                        category: req.body.userScopeEmail,
                        action: configruation.user_service_events.event_action.Users,
                        label: configruation.user_service_events.authorized_event_label.get_userData_failed.replace('{{user}}', req.query.userScopeName)
                    });
                    ...
                    analyticsServices.registerEvents({
                        category: req.body.userScopeEmail,
                        action: configruation.user_service_events.event_action.Users,
                        label: configruation.user_service_events.authorized_event_label.get_userData_success.replace('{{user}}', req.query.userScopeName)
                    });
        ...
        return authorizedLibs.updateUserProfiles(req.body.userScopeId, requestBody.user)
            .then((updatedData) => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.update_profile.replace('{{user}}', req.query.userScopeName)
                });
                ...
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.update_profile_failed.replace('{{user}}', req.query.userScopeName)
                });
        ...
        return authorizedLibs.changePaymentType(req.body.userScopeId, req.query.currentPaymentType, req.query.newPaymentType)
            .then((result) => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_payment_type.replace('{{user}}', req.query.userScopeName),
            ...
            .catch((error) => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_payment_type_failed.replace('{{user}}', req.query.userScopeName)
                });
                res.status(200).json({ code: 404, status: "failed", error: error.message });
            });
        ...
        return authorizedLibs.change2StepOptions(req.body.userScopeId, req.query.twoStepActivate)
            .then(() => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_twostep.replace('{{user}}', req.query.userScopeName),
            ...
            .catch((error) => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_twostep_failed.replace('{{user}}', req.query.userScopeName)
                });
                res.status(200).json({ code: 404, status: "failed", error: error.message });
            });
    }
        ...
        return authorizedLibs.changePlan(req.body.userScopeId, req.query.currentPlan, req.query.newPlan)
            .then((result) => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_plan.replace('{{user}}', req.query.userScopeName),
            ...
            .catch((error) => {
                analyticsServices.registerEvents({
                    category: req.body.userScopeEmail,
                    action: configruation.user_service_events.event_action.Users,
                    label: configruation.user_service_events.authorized_event_label.change_plan_failed.replace('{{user}}', req.query.userScopeName)
                });
                res.status(200).json({ code: 404, status: "failed", error: error.message });
            });
    }
