...
taskModel.methods.getTeamPublishTaskLists = function (
  assignedTo,
  teamId,
  skip,
  limit
...
taskModel.methods.getSchedulePublishTaskLists = function (
  assignedTo,
  teamId,
  skip,
  limit
...
taskModel.methods.getNormalPublishTaskLists = function (
  assignedTo,
  teamId,
  skip,
  limit
    ...
    .findOneAndUpdate(
      {
        ...
        ownerId: {$ne: assignId},
        status: {$nin: ['Solved', 'Rejected']},
      },
      {
        $push: {
          assignedUser: {
            assignedTo: Number(assignId),
...
taskModel.methods.updatePublishTaskStatus = function (
  assignedTo,
  taskId,
  teamId,
  status
