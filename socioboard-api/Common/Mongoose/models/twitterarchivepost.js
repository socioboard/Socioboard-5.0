...
twitterarchivepost.methods.getSocialAccountPosts = function (
  accountId,
  skip,
  limit
) {
...
twitterarchivepost.methods.deleteMediaFile = function (
  accountId,
  isArray,
  skip,
  limit
...
twitterarchivepost.methods.updateLikeRetweetCount = function (
  tweetId,
  favoriteCount,
  retweetCount
) {
...
twitterarchivepost.methods.addcomments = function (
  tweetId,
  message,
  commentedId,
  mediaUrls
  ...
  var updateObject = {
    $push: {
      comments: {
        message: message,
        mediaUrls: mediaUrls,
        commentedId: String(commentedId),
      },
    },
  };
  return this.model('TwitterArchivePost')
...
twitterarchivepost.methods.setdeleteStatus = function (
  accountId,
  tweetId,
  deleteStatus
) {
...
twitterarchivepost.methods.getNumberOfTweet = function (
  social_id,
  isforTeam,
  data
) {
...
twitterarchivepost.methods.getArchivedTweetDayWise = function (
  social_id,
  isforTeam
) {
  var list = [];
...
twitterarchivepost.methods.getArchivedAccountDetails = function (
  social_id,
  isforTeam
) {
  var list = [];
...
twitterarchivepost.methods.getSentimentAnalysis = function (
  social_id,
  isforTeam
) {
  var list = [];
...
twitterarchivepost.methods.setSentimentStatus = function (
  socialAccount,
  tweetId,
  sentimentStatus
) {
...
twitterarchivepost.methods.getCustomTagsFeeds = function (
  socialAccount,
  tweetId,
  groupName
) {
...
twitterarchivepost.methods.setCustomTag = function (
  socialAccount,
  tweetId,
  customeTagValue
) {
...
twitterarchivepost.methods.setCustomTags = function (
  socialAccount,
  tweetId,
  customeTagValue
) {
...
twitterarchivepost.methods.setCustomTagsSpecificGroup = function (
  socialAccount,
  tweetId,
  customeTagValue
) {
...
twitterarchivepost.methods.getArchivedAccountReportsOld = function (
  social_id,
  isforTeam,
  startDate,
  endDate,
        ...
        for (var c in result) {
          ...
          for (var i = 0; i < social_id.length; i++) {
            if (result[c].accountId == social_id[i].social_id) {
              tempObj[social_id[i].social_id] =
                tempObj[social_id[i].social_id] + 1;
            }
          }
        }
        data = {
...
twitterarchivepost.methods.getArchivedAccountReports = function (
  social_id,
  isforTeam,
  startDate,
  endDate,
...
twitterarchivepost.methods.getArchivedAccountReportsAccounts = function (
  social_id,
  isforTeam,
  startDate,
  endDate,
...
twitterarchivepost.methods.getArchivedAccountReportStats = function (
  social_id,
  isforTeam,
  startDate,
  endDate,
...
twitterarchivepost.methods.getArchivedAccountReportsold1 = function (
  social_id,
  isforTeam,
  startDate,
  endDate,
            ...
            for (var e in custometag) {
              if (result[c].customtags.length != 0) {
                for (var f in result[c].customtags) {
                  if (
                    result[c].customtags[f].groupname == custometag[e].groupname
                  )
                    if (
                      custometag[e].customtags.every(v =>
                        result[c].customtags[f].customtags.includes(v)
                      )
                    ) {
                      d = d + 1;
...
twitterarchivepost.methods.removeSocialAccountPosts = function (
  accountId,
  isArray,
  skip,
  limit
...
twitterarchivepost.methods.getSocialAccountPostsArray = function (
  accountId,
  skip,
  limit
) {
...
const twitterarchiveModel = mongoose.model(
  'TwitterArchivePost',
  twitterarchivepost
);
