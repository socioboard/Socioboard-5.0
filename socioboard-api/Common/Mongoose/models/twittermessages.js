...
twitterMessage.methods.getSocialAccountPosts = function (
  accountId,
  skip,
  limit
) {
...
twitterMessage.methods.getMessageBetweenUsers = function (
  senderId,
  receiverId,
  skip,
  limit
...
twitterMessage.methods.getMessageBetweenTwoUsers = function (
  userId1,
  userId2,
  skip,
  limit
...
twitterMessage.methods.getPreviouslyMessagedUsers = function (
  senderId,
  screenName,
  skip,
  limit
        ...
        $group: {
          ...
          receivers: {
            $push: {
              ...
              screenName: '$receiverInfo.screenName',
              profileUrl: '$receiverInfo.profileUrl',
              socialId: '$receiverInfo.receiverId',
            },
          },
          senders: {
            $push: {
              name: '$senderInfo.name',
              screenName: '$senderInfo.screenName',
              profileUrl: '$senderInfo.profileUrl',
              socialId: '$senderInfo.senderId',
            },
          },
        },
      },
