...
adminApprovalPosts.methods.getAdminApprovalPost = function (
  ownerId,
  teamId,
  skip,
  limit
...
adminApprovalPosts.methods.updateAdminResponse = function (
  taskId,
  adminResponse
) {
  return this.model('AdminApprovalPost')
...
const AdminApproalPostModel = mongoose.model(
  'AdminApprovalPost',
  adminApprovalPosts
);
