...
import INSTAGRAM_CONSTANTS from '../Constants/instagram.constants.js';
...
/**
 * TODO makes a request and receives a page with statistics
 *
 * @param {string} countryCode
 * @returns {object} query result
 */
Instagram.prototype.getStatsPage = (countryCode) => axios({
  method: 'GET',
  url: INSTAGRAM_CONSTANTS.API_URI.TAGSFINDER_STATS_PAGE,
  params: {
    country: countryCode,
  },
});
...
/**
 * TODO makes a request and receives a page with countries
 *
 * @returns {object} query result
 */
Instagram.prototype.getSearchPage = () => axios({
  method: 'GET',
  url: INSTAGRAM_CONSTANTS.API_URI.TAGSFINDER_SEARCH_PAGE,
});
