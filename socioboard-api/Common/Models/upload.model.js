                  ...
                  return this.generateThumbnail(
                    ...
                    .then(thumbnail => {
                      ...
                      return this.generateWaterMark(thumbnail)
                        .then(waterMarkFile => {
                          var isThumbnailUrlExists = fs.existsSync(
                            String(thumb_image)
                          );
                  ...
                  return Promise.all(
                    ...
                    if (size < totalSize) {
                      ...
                      return reject({
                        error: true,
                        message:
                          'Sorry! You reached maximum size of upload data.',
                      });
                  });
                })
                .catch(error => {
    ...
    return new Promise((resolve, reject) => {
      if (!userId || !fileData) {
        ...
        return this.base64ToPNG(fileData.media, optionalObj)
          ...
          .then(() => {
            return userSSTemplatesTable.bulkCreate(mediaDetails, {
              returning: true,
            });
          })
          .then(details => {
        ...
        .then(() => {
          return userSSTemplatesTable
            ...
            .then(data => {
              ...
              else resolve('Templates successfully deleted!');
            })
            .catch(error => {
              throw new Error(error.message);
            });
      ...
      if (!userId || !templateId) {
        ...
        return userSSTemplatesTable
          ...
          .then(data => {
            ...
            let media_url = `${config.get('uploadService.basePath')}/${
              data.dataValues.media_url
            }`;
          ...
          .then(() => {
            return userSSTemplatesTable
              ...
              .then(data => {
                if (!data) return reject(new Error('No such media found!'));
                else resolve('Media has been deleted successfully!');
              })
              .catch(error => {
                throw new Error(error.message);
              });
