                ...
                return this.makeSchedule(scheduledId, todaysTiming)
                  ...
                  .catch(expiredTimings => {
                    resolve({
                      ...
                      expiredTimings: expiredTimings,
                    });
                  });
              } else resolve({message: createdResponse});
            } else {
        ...
        return scheduleDetails
          ...
          .then(() => {
            return scheduledInformations
              ...
              .then(() => {
                return SchedulePost.findByIdAndRemove(
          ...
          .then(scheduleData => {
            if (!scheduleData)
              ...
              if (scheduleData.schedule_status == 5 && newScheduleStatus == 1) {
                    ...
                    .then(schedulePostInfo => {
                      ...
                      // OneTime schedule
                        ...
                        scheduleTimings.push(
                          schedulePostInfo.normalScheduleDate
                        );
                        return this.getRunningDayAndTodayTimings(
                          scheduleTimings
                        )
                ...
                scheduleData.schedule_status == 3 &&
                newScheduleStatus == 5
              ) {
                // Delete the task
                var taskModels = new TaskModel();
