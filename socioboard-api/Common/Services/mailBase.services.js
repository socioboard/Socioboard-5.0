...
import MailServiceMongoModel from '../Mongoose/models/mailservices.js';
...
class MailService extends MailBase {
    ...
    */
        ...
        return new Promise((resolve, reject) => {
            ...
            switch (scheduleObject.moduleId) {
                case 1:
                    ...
                    emailTitle = "SocioBoard plan will expire in few days!";
                    break;
                case 2:
    ...
    sendNotificationMails(scheduleObject, emailTitle, emailContent, newsletterContent) {
        ...
        return new Promise((resolve, reject) => {
            return Promise.all(scheduleObject.users.map(user => {
                ...
                return this.sendMails(this.mailServiceConfig.defaultMailOption, emailDetails)
