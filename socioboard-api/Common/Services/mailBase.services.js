...
class MailService extends MailBase {
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="left" style="background: #fff; margin: 0; margin:0; font-family: Open sans, Arial, Helvetica, sans-serif; font-size: 17px; color: #383737; line-height: 24px;mso-line-height-rule: exactly; text-align: left; padding: 0 5px; padding-bottom:0px; " align="left">
                                                                                        <span>We are excited to have to get started. First, you need to confirm your account. Just press the button below and you're ready to gain all the access to Socioboard.</span>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td width="100%" height="30">&nbsp;</td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="center" style="margin: 0; padding-bottom:0px; margin:0; font-family: Open sans, Arial, Helvetica, sans-serif; font-size: 16px; color: #e9e9e9; line-height: 25px;mso-line-height-rule: exactly; text-align: center;" align="center">
                                                                                        <a target="_blank" href="[ActivationLink]" style="background: #f85c37; border: 0px; padding: 12px 20px; color: #fff; font-size: 18px; letter-spacing: 1px; margin-top: 14px; cursor: pointer; font-weight: 600; border-radius: 80px; text-decoration: none;">Verify Account</a>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
    ...
    */
    ...
    sendNotificationMails(scheduleObject, emailTitle, emailContent, newsletterContent) {
        return new Promise((resolve, reject) => Promise.all(scheduleObject.users.map((user) => {
