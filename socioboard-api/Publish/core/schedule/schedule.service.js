...
class ScheduleService {
  ...
  async getSchedulePostById(req, res, next) {
    try {
      const response = await scheduleModel.getSchedulePostById(req.body.userScopeId, req.query.id);
      const result = await scheduleModel.getScheduleId(req.body.userScopeId, req.query.id, response);
  ...
  async editDraftSchedule(req, res, next) {
    try {
      const id = await scheduleModel.editDraftSchedule(req.body.userScopeId, req.body.userScopeName, req.query.teamId, req.query.scheduleId, req.body.postInfo);
      const response = await scheduleModel.getSchedulePostById(req.body.userScopeId, id);
      const result = await scheduleModel.getScheduleId(req.body.userScopeId, id, response);
