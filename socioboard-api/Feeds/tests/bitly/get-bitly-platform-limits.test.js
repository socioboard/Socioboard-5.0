...
import { GET_BITLY_PLATFORM_LIMITS, SERVER } from '../constants.js';
...
describe('Get bitly platform limits test', () => {
  ...
  const user = {
    username: 'testGetProfileLimits',
    email: 'testGetProfileLimits@testtesttestabcd.com',
