...
class TrendService {
  ...
  async getGiphy(req, res, next) {
    try {
      ...
      let response = await this.trendsServices.fetchGiphy(
  ...
  async getImgur(req, res, next) {
    try {
      ...
      let response = await this.trendsServices.fetchImgur(
  ...
  async getFlickr(req, res, next) {
    try {
      ...
      let response = await this.trendsServices.fetchFlickr(
  ...
  async getDailyMotion(req, res, next) {
    try {
      ...
      let response = await this.trendsServices.fetchDailyMotion(
  ...
  async getNewsAPI(req, res, next) {
    try {
      ...
      let response = await this.trendsServices.fetchNewsApi(
  ...
  async getPixabay(req, res, next) {
    try {
      const {keyword, pageId, sortBy, category} = req.query;
      let response = await this.trendsServices.fetchPixabay(
  ...
  async getYoutube(req, res, next) {
    try {
      ...
      let response = await this.trendsServices.fetchYoutube(
  ...
  async getTwitter(req, res, next) {
    try {
      ...
      let raw_tweets = await this.twitterHelper.fetchTweetsKeywords(
        config.get('twitter_data'),
        keyword,
        max_id,
        since_id
      );
      let response = await this.twitterHelper.parseTweetDetailsForKeyword(
        raw_tweets
      );
      SuccessResponse(res, response);
    } catch (error) {
