...
import TrendsValidate from './trend.validate.js'
...
class TrendService {
    ...
    async getGiphy(req, res, next) {
        try {
            ...
            let response = await this.trendsServices.fetchGiphy(config.get('content_studio.giphy'), keyword, pageId, rating, type)
            // if (response.batchId) {
    ...
    async getImgur(req, res, next) {
        try {
            ...
            let response = await this.trendsServices.fetchImgur(config.get('content_studio.imgur'), keyword, pageId, sortBy)
    ...
    async getFlickr(req, res, next) {
        try {
            ...
            let response = await this.trendsServices.fetchFlickr(config.get('content_studio.flickr'), keyword, pageId, sortBy)
    ...
    async getDailyMotion(req, res, next) {
        try {
            ...
            let response = await this.trendsServices.fetchDailyMotion(config.get('content_studio.daily_motion'), keyword, pageId, sortBy)
    ...
    async getNewsAPI(req, res, next) {
        try {
            ...
            let response = await this.trendsServices.fetchNewsApi(config.get('content_studio.newsapi'), keyword, pageId, sortBy, category)
            SuccessResponse(res, response);
    ...
    async getPixabay(req, res, next) {
        try {
            const { keyword, pageId, sortBy, category } = req.query
            let response = await this.trendsServices.fetchPixabay(config.get('content_studio.pixabay'), keyword, pageId, sortBy, category)
            SuccessResponse(res, response);
        } catch (err) {
            return CatchResponse(res, err.message);
        }
    ...
    async getYoutube(req, res, next) {
        try {
            ...
            let response = await this.trendsServices.fetchYoutube(config.get('content_studio.youtube'), pageId, keyword, sortBy)
            SuccessResponse(res, response);
        } catch (error) {
    ...
    async getTwitter(req, res, next) {
        try {
            ...
            let raw_tweets = await this.twitterHelper.fetchTweetsKeywords(config.get('twitter_data'), keyword, max_id, since_id)
            let response = await this.twitterHelper.parseTweetDetailsForKeyword(raw_tweets)
            SuccessResponse(res, response);
