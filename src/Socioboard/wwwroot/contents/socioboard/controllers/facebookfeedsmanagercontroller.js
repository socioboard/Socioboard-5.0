...
SocioboardApp.controller('FacebookFeedsManagerController', function ($rootScope, $scope, $http, $timeout, $stateParams, apiDomain, domain) {
    //alert('helo');
    $scope.$on('$viewContentLoaded', function() {   
        ...
        $scope.loadProfileDetails = function () {
            $http.get(apiDomain + '/api/Facebook/GetFbAccSingle?accId=' + $stateParams.profileId)
        ...
        //for scheduleing feeds start
        $scope.schdule = function(detail) {
       
            $http.get(apiDomain + '/api/SavedFeedsManagement/ScheduleMsg?profileId=' + $stateParams.profileId)
                        .then(function (response) {
                            $scope.schfeed = response.data;
                        }, function (reason) {
                            $scope.error = reason.data;
        ...
        $scope.hideHeader = function () {
            ...
            console.log("headerd", $scope.hideheadernames);
        }
