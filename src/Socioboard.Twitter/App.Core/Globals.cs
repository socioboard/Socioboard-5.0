...
namespace Socioboard.Twitter.App.Core
{
    ...
    public static class Globals
    {
        ...
        public static string GetDirectMesagesUrl = "https://api.twitter.com/1.1/direct_messages/events/list.json";//https://api.twitter.com/1.1/direct_messages.json
        public static string GetDirectMessagesSentUrl = "https://api.twitter.com/1.1/direct_messages/events/list.json";//"https://api.twitter.com/1.1/direct_messages/sent.json"
